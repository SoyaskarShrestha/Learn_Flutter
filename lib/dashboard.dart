...
import 'package:demo/controller/counter_controller.dart';
import 'package:demo/controller/sample_list_controller.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(onPressed: ()=> sampleListController.deleteDataFromList('Hello'),
                          ...
                          GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              Navigator.of(dashboardContext)
                                  .pushReplacementNamed('/login_Form');
                            },
                          ),
                          GestureDetector(
                            child: Text('No'),
